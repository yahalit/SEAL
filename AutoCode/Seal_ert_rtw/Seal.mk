...
START_DIR                 = C:\Projects\SEAL\SealApp\AutoCode
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
COMPILER_COMMAND_FILE     = Seal_comp.rsp
CMD_FILE                  = Seal.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
NODEBUG                   = 1
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\Seal.exe
...
DEFINES_STANDARD = -DMODEL=Seal -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
{$(START_DIR)\Seal_ert_rtw}.c.obj:
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\Seal_ert_rtw}.cpp.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\Seal_ert_rtw}.cc.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\Seal_ert_rtw}.cxx.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{C:\Projects\SEAL\SealApp\ExternalCode}.c.obj:
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{C:\Projects\SEAL\SealApp\ExternalCode}.cpp.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{C:\Projects\SEAL\SealApp\ExternalCode}.cc.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{C:\Projects\SEAL\SealApp\ExternalCode}.cxx.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
Seal.obj : "$(START_DIR)\Seal_ert_rtw\Seal.c"

 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Sat Sep 06 19:57:13 2025
 */
...
/* Input Port  0 */
#define IN_PORT_0_NAME                 CommUART
#define INPUT_0_DIMS_ND                {1,256}
#define INPUT_0_NUM_ELEMS              256
#define INPUT_0_WIDTH                  1
#define INPUT_DIMS_0_COL               256
...
/* Input Port  1 */
#define IN_PORT_1_NAME                 CommCAN
#define INPUT_1_DIMS_ND                {1,256}
#define INPUT_1_NUM_ELEMS              256
#define INPUT_1_WIDTH                  1
#define INPUT_DIMS_1_COL               256
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port CommUART of S-Function DriveSimulation");
      return;
    }
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port CommCAN of S-Function DriveSimulation");
      return;
    }
...
{
  const real_T *CommUART = (real_T *) ssGetInputPortRealSignal(S, 0);
  const real_T *CommCAN = (real_T *) ssGetInputPortRealSignal(S, 1);
  ...
  DriveSimulation_Outputs_wrapper(CommUART, CommCAN, DrvCommand, SetupReport,
    PhaseVoltages, xD, S);
}
...
static void mdlUpdate(SimStruct *S, int_T tid)
{
  ...
  DriveSimulation_Update_wrapper(CommUART, CommCAN, DrvCommand, SetupReport,
    PhaseVoltages, xD, S);
}
